...
import { addUser } from '../APICRUD2/Apicalls';
...
export default function AddUser() {
    ...
    let handleSubmit=()=>{
        ...
        addUser(addUserInfo).then(()=>navigate("/")).catch(err=>console.log(err));
    }
  return (
    <div className='card'>
      ...
      <div className='card-body'>
        ...
        <div>
            ...
            <input type="text" name="mail" id="mail" className='form-control' onChange={handleChange}/>
        </div>
        <div>
